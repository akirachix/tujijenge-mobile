...
fun AppNavigation() {
    ...
    NavHost(navController = navController, startDestination = "enter_pin") {
        ...
        composable(
            ...
            // Retrieve Boolean argument safely (NavType.BoolType ensures it's a Boolean)
            ...
            if (showDialog) {
                AllowLocationScreen(
                    onAllow = { showDialog = false /* Request location here */ },
                    onDeny = { showDialog = false /* Handle denial */ }
                )
            }
        }
    }
